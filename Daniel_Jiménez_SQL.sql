...
ACCEPT codigo PROMPT 'Introduce el código del cliente';
...
ACCEPT codigo PROMPT 'Introduce el código del producto';
...
// Mostrar toda la informacion de un pedido dado su código
...
un cliente. Pasa el código por teclado. //
...
//PRÁCTICA BASE DE DATOS "Restaurante en casa S.A."//
...
(
    ...
    CONSTRAINT pk_carta FOREIGN KEY (cartarest, cartaplat),
...
(
    ...
    direcclie VARCHAR2(100),
    usuario VARCHAR2(50) NOT NULL,
    contraseña VARCHAR2(50) NOT NULL,
    
    CONSTRAINT fk_direc_clie FOREIGN KEY (direcclie) REFERENCES direccion(.....)
);
